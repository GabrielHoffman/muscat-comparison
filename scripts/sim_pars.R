...
sim_pars <- list(
    # null simulations
    nill = list(nr = 5, p_dd = diag(6)[1, ], seed = 1), 
    # pure simulations
    ...
    de10_ng = list(nr = 5, nk = 2, ns = 5, seed = 80, nc = 2*2*3*100),
    de10_nc = list(nr = 5, nk = 2, ns = 5, seed = 90, nc = 2*2*3*500)
...
def_pars <- list(nr = 1, nk = 3, ns = 5, 
    ng = 8000, nc = function(nk, ns) 2*nk*ns*400, 
